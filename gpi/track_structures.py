...
def track_structures(frame_properties=None,
                     ...
                     max_gap=3,                                               #allow tracking over gaps by introducing memory weights
    ...
    if (not nocalc) or recalc_tracking:
        ...
        for i_frames in range(1,n_frames):
            ...
            if structures_1 and not structures_2:
                ...
                # if i_frames > max_gap:
                #     n_born = 0
                #     for j_str2, cur_str_2 in enumerate(structures_2):
                #         if cur_str_2['Born']:
                #             n_born += 1
                ...
                #             _, structures_2, highest_label = _process_structure_merging(structures_before_gap,structures_2,
                #                                                                         str_overlap_matrix,
                #                                                                         ind_gap,
                #                                                                         sample_time * ind_gap,
                #                                                                         fit_shape,
                ...
                #Loop over structures_2 and see if there is a born structure
                #Calculate the structure overlap matrix between structures_2 and structures_0 (i_frames - gap)
                #If there is overlap for the newborn structure, assign the label of structure_0 to it, set born to False
        ...
        frame_properties['structures'][i_frames]=structures_1.copy()
...
def _remove_orphans(frame_properties,
    ...
    for i in range(len(frame_properties['structures'])-1,-1,-1):
        if frame_properties['structures'][i] == []:
            frame_properties['structures'].pop(i)
